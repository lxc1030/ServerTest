...
public class PeopleInfo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Fomat = Vector3.Distance(Head.position, MyController.instance.firstCamera.transform.position);
    }
    ...
    void Update()
    {
        ...
        float newFomat = Fomat / Vector3.Distance(Head.position, MyController.instance.firstCamera.transform.position);
    ...
    {
        Vector3 pt = MyController.instance.firstCamera.WorldToScreenPoint(point);
