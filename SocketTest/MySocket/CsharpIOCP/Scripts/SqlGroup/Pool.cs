...
namespace DateBaseConnectionPool
{
    ...
    public class ConnectionPool : IDisposable
    {
        ...
        #region LRK提取数值
        private int orgMaxConnection = 200; /// 初始化的最大连接数-200
        private int orgMinConnection = 1;//初始化的最小连接数-1
        private int orgSeepConnection = 10;//每次创建连接的连接数-10
        private int orgKeepConnection = 5;//保留的实际空闲连接，以攻可能出现的ReadOnly使用，当空闲连接不足该数值时，连接池将创建seepConnection个连接-5
        private int orgKeepRealConnection = 5;//保留的实际空闲连接，以攻可能出现的ReadOnly使用，当空闲连接不足该数值时，连接池将创建seepConnection个连接-5
        #endregion
        /// <summary>
        /// 初始化连接池
        /// </summary>
        ...
        { InitConnectionPool(connectionString, ConnTypeEnum.Odbc, orgMaxConnection, orgMinConnection, orgSeepConnection, orgKeepConnection, orgKeepRealConnection); }
        /// <summary>
        /// 初始化连接池
        /// </summary>
        /// <param name="connectionString">数据库连接字符串</param>
        ...
        { InitConnectionPool(connectionString, cte, orgMaxConnection, orgMinConnection, orgSeepConnection, orgKeepConnection, orgKeepRealConnection); }
        /// <summary>
        /// 初始化连接池
        /// </summary>
        /// <param name="connectionString">数据库连接字符串</param>
        ...
        { InitConnectionPool(connectionString, cte, maxConnection, minConnection, orgSeepConnection, orgKeepConnection, orgKeepRealConnection); }
        /// <summary>
        /// 初始化连接池
        /// </summary>
        /// <param name="connectionString">数据库连接字符串</param>
        ...
        { InitConnectionPool(connectionString, cte, maxConnection, minConnection, seepConnection, keepConnection, orgKeepRealConnection); }
        /// <summary>
        /// 初始化连接池
        /// </summary>
        /// <param name="connectionString">数据库连接字符串</param>
